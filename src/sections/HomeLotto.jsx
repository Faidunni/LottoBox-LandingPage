...
function HomeLotto() {
  ...
  return (
    <div
      className="bg-custom-gradient flex flex-col lg:flex-row items-center lg:items-start p-4 sm:p-8 lg:p-[48px] max-w-[90%] lg:max-w-[920px] mx-auto my-6 lg:my-10 justify-between gap-6"
      data-aos="fade-right"
    >
      <img
        src={house}
      ...
      <div className="flex flex-col lg:ml-4 lg:flex-row items-center lg:items-start">
        ...
        <div className="flex flex-col items-center lg:items-start mt-4 lg:mt-0">
          ...
          <Link to="/lottopage">
            <button className="bg-nav-text text-white py-2 px-4 rounded-full w-[200px] sm:w-[250px] font-DM Sans font-normal text-[18px] sm:text-[20px]">
              Play Now
            </button>
          </Link>
        </div>
